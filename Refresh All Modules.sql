...
USE DbaMetrics;
DROP TABLE IF EXISTS dbo.InvalidObjectDefinitions;

CREATE TABLE dbo.InvalidObjectDefinitions (
	ID INT IDENTITY
...
BEGIN
	...
	BEGIN CATCH
		...
		INSERT INTO DbaMetrics.dbo.InvalidObjectDefinitions(DBName, SchemaName, ObjectName, ObjectType, ErrMsg)
