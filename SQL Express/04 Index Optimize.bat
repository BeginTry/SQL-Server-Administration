...
sqlcmd -E -S .\SQLEXPRESS -d master -Q "EXECUTE [dbo].[IndexOptimize] @Databases = 'ALL_DATABASES', @UpdateStatistics = 'ALL', @MSShippedObjects = 'Y', @LogToTable = 'Y'" -b -o "%~dp0Logs\%~n0__1_%DateTime%.txt"
