...
sqlcmd -E -S .\SQLEXPRESS -d master -Q "EXECUTE dbo.DatabaseBackup @Databases = 'ALL_DATABASES', @Directory = N'C:\Storage\Backup', @BackupType = 'FULL', @CleanupTime = 192" -b -o "%~dp0Logs\%~n0__1_%DateTime%.txt"
